...
<title>Art In Paradise: Bảo tàng tranh 3D tại Đà Nẵng đầu tiên</title>

<meta property="og:title"
	content="Art In Paradise: Bảo tàng tranh 3D tại Đà Nẵng đầu tiên" />
				...
				<div class="container">
								...
								typeof="v:Breadcrumb"><a href="index.jsp" rel="v:url"
									...
									typeof="v:Breadcrumb"><a href="Subject_TinTuc.jsp" rel="v:url"
										...
										typeof="v:Breadcrumb"><a href="Subject_CuocSong.jsp"
											...
											class="breadcrumb_last">Art In Paradise: Bảo tàng
												tranh 3D tại Đà Nẵng đầu tiên</span></span></span></span></span>
						</p>
					</ol>
					...
					<div class="hk-left-ct">
						<div class="block-product">
							<h2 class="title">
								<span>Art In Paradise: Bảo tàng tranh 3D tại Đà Nẵng đầu
									tiên</span>
							</h2>
							...
							<article class="post-content">
								<h2 class="knc-sapo">Art in Paradise Danang là Bảo tàng
									tranh 3D tại Đà Nẵng đầu tiên vừa mới được khai trương ngày
									15/07/2017 tại Lô C2-10 Trần Nhân Tông, Sơn Trà, Đà Nẵng</h2>
								<p>Bảo tàng xoay quanh vật thể 3 chiều, sử dụng nghệ thuật
									ngụy trang hay còn được gọi là nghệ thuật vẽ trên các bề mặt
									khác nhau: tường, sàn, trần nhà… Đòi hỏi kỹ thuật chuyên môn
									cao “biến” bức tranh trên bề mặt phẳng trở thành ảo ảnh, tạo
									cảm giác mọi vật đang sống động như thật.</p>

								<p>
									<img class="aligncenter size-full" src="img/bt.jpg" alt=""
								...
								<div class="knc-content">
									...
									<br />
									<p>Art in Paradise Danang còn là hiện thân của nghệ thuật
										tương tác đòi hỏi sự tham gia của khán giả để hoàn thiện tác
										phẩm nghệ thuật 3D. Trong khi tại các Bảo tàng thông thường
										khác, Bạn không được phép chạm hay xem các chi tiết tác phẩm.
										Tại Art in Paradise Danang Bạn không chỉ tự do chạm vào, chụp
										ảnh những cử chỉ và cách diễn đạt sáng tạo sáng để tương ứng
										với từng bức tranh của riêng mình. Tương tác là nghệ thuật và
										người tham gia là một nghệ sĩ.</p>
									<p>Bảo tàng 3D Đà Nẵng – Art in Paradise Danang mang đến sự
										thú vị, hài hước của việc khám phá nghệ thuật tranh 3D và tự
										mình tham gia tạo nên các tác phẩm nghệ thuật 3D. Khiến thưởng
										thức nghệ thuật trở nên dễ dàng và hài hước hơn bao giờ hết.</p>
									<p>Được đầu tư bởi công ty Art in Paradise Global, đã xuất
										hiện tại các quốc gia: Pattaya, Bangkok, Chaingmai (Thái Lan);
										Malaysia; Úc và bây giờ là Tp. Đà Nẵng. Đây là Bảo tàng thứ 6
										thuộc công ty Art in Paradise Global.</p>
									<p>Bảo tàng tranh 3D tại Đà Nẵng – Art In Paradise Danang
										có diện tích trên 4000M 2 , 9 khu vực chủ đề chuyên biệt với
										hơn 130 tác phẩm được thực hiện bởi gần 20 nghệ sĩ hàng đầu
										đến từ Hàn Quốc. Trong đó Tầng 1 sẽ bao gồm 5 khu vực chủ đề:
										Ảo ảnh – Optical, Nghệ thuật cổ điển – Classic, Đại dương –
										Aqua, Động vật hoang dã – Saffari, Thế giới thần tiên –
										Fantasy.</p>

									<p>
										<img class="aligncenter size-full" src="img/bt1.jpg" alt=""
											width="600" height="400" />
									</p>

									<p>Tầng 2 được chia làm 4 khu vực chính: Ai cập cổ đại –
										Egyption, Thế giới – Word, Căn phòng bí ẩn (Phối cảnh thị
										giác) – Trick Art, Hiện đại – Modern. Du khách phải mất vài
										giờ đồng hồ để khám phá hết toàn bộ Bảo tàng.</p>
								</div>
							</article>
						</div>
						<!-- End block-product -->
