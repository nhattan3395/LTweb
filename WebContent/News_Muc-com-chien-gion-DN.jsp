...
<title>Mực cơm chiên giòn Đà Nẵng</title>

<meta property="og:title" content="Mực cơm chiên giòn Đà Nẵng" />
				...
				<div class="container">
								...
								typeof="v:Breadcrumb"><a href="index.jsp" rel="v:url"
									...
									typeof="v:Breadcrumb"><a href="Subject_TinTuc.jsp" rel="v:url"
										...
										typeof="v:Breadcrumb"><a href="Subject_CuocSong.jsp"
											...
											class="breadcrumb_last">Mực cơm chiên giòn Đà Nẵng</span></span></span></span></span>
						</p>
					</ol>
					...
					<div class="hk-left-ct">
						<div class="block-product">
							<h2 class="title">
								<span>Mực cơm chiên giòn Đà Nẵng</span>
							</h2>
							...
							<article class="post-content">
								<h2 class="knc-sapo">Du Lịch Đà Nẵng thưởng thức món Mực
									cơm ở Đà Nẵng có màu tím hồng, mình tròn lẳn bằng khoảng ngón
									tay cái, tách ra trong ruột có phần cơm màu trắng, chính thành
									phần này làm tăng thêm hương vị riêng độc đáo của mực cơm. Bạn
									sẽ tò mò không hiểu tại sao trong ruột mực lại có phần cơm màu
									trắng như vậy ?.</h2>
								<p>Đó chính là trứng mực vào mùa sinh sản, có giá trị dinh
									dưỡng rất cao. Mùa mực cơm ở Đà Nẵng thường vào tháng 6 đến
									tháng 9..</p>

								<div class="knc-content">
									<p>
										<img class="aligncenter size-full" src="img/tt.jpg" alt=""
									...
									<br />
									<p>Hải sản Đà Nẵng cực kì đa dạng và phong phú… Bất kể đâu
										du khách cũng có thể được thưởng thức những món ngon chế biến
										từ hải sản. Đặc biệt phải kể đến món mực cơm chiên giòn, món
										ăn Đà Nẵng rất đặc sắc.</p>
									<p>
										<img class="aligncenter size-full" src="img/tt1.jpg" alt=""
											width="600" height="400" />
									</p>
									<p>Vào nhà hàng, gọi ngay một đĩa cơm chiên giòn, một lát
										sau bạn sẽ được thưởng thức món ngon Đà Nẵng hảo hạng này. Mùi
										hương thơm lừng lan tỏa, vị tươi ngọt của thịt mực kết hợp với
										bột chiên, bạn sẽ có cảm giác hòa quyện giữa sự mềm mại và
										giòn tan vô cùng thú vị. Đặc biệt món này dùng nóng kèm với
										tương ớt và và một ít rau quả như cà chua, dưa leo tạo thêm vị
										tươi mát của món ăn.</p>
									<p>
										<img class="aligncenter size-full" src="img/tt1.jpg" alt=""
											width="600" height="400" />
									</p>
