...
<title>Mỗi chiếc iPhone X bán ra, Apple 'ăn dày' đến 2/3</title>

<meta property="og:title"
	content="Mỗi chiếc iPhone X bán ra, Apple 'ăn dày' đến 2/3" />
				...
				<div class="container">
							...
							<i class="fa fa-home"></i> <span
								...
								typeof="v:Breadcrumb"><a href="index.jsp" rel="v:url"
									...
									typeof="v:Breadcrumb"><a href="Subject_TinTuc.jsp" rel="v:url"
										...
										typeof="v:Breadcrumb"><a href="Subject_CongNghe.jsp"
											rel="v:url" property="v:title">Công nghệ</a> / <span
											class="breadcrumb_last">Mỗi chiếc iPhone X bán ra,
												Apple 'ăn dày' đến 2/3</span></span></span></span></span>
						</p>
					</ol>
					...
					<div class="hk-left-ct">
						<div class="block-product">
							<h2 class="title">
								<span>Mỗi chiếc iPhone X bán ra, Apple 'ăn dày' đến 2/3</span>
							</h2>
							...
							<article class="post-content">
								<h2 class="knc-sapo">Giá bán lẻ cao ngất ngưởng và đổ lỗi
									cho chi phí màn hình OLED, nhưng Apple vẫn lời rất nhiều trên
									mỗi chiếc iPhone.</h2>
								<p>Theo những nhà nghiên cứu tại TechInsights, Apple mất
									357,5 USD để làm ra chiếc iPhone X bản thấp nhất. Như vậy, hãng
									ăn lời đến 64% so với giá bán lẻ.</p>
								<p>Đây là kỷ lục mới. Trước đó, có thông tin cho rằng Apple
									chỉ mất 295 USD để làm ra chiếc iPhone 8 Plus, và ăn lời 59%
									trên mỗi chiếc bán ra.</p>

								<p>
									<img class="aligncenter size-full" src="img/ip.jpg" alt=""
								...
								<div class="knc-content">
									...
									<br />
									<p>Tuy nhiên, phần lợi nhuận lớn này cũng sẽ bao gồm chi
										phí bù vào cho R&D (nghiên cứu và phát triển), trả lương cho
										nhân công và marketing.</p>
									<p>Nói với Reuters, Apple cho biết màn hình của iPhone 8 có
										giá 36 USD, nhưng màn hình Super AMOLED 5,8 inch mua từ
										Samsung có giá lên đến 65 USD. Khung nhôm của iPhone 8 có giá
										21,5 USD nhưng khung thép không gỉ của iPhone X lên đến 36
										USD. Đây là hai bộ phận đắt tiền nhất của iPhone X khiến giá
										bán lẻ của máy tăng cao.</p>
								</div>
							</article>
						</div>
						<!-- End block-product -->
