...
<title>Âm nhạc đường phố đà nẵng, sự kiện đặc sắc đà nẵng</title>

<meta property="og:title"
	content="Âm nhạc đường phố đà nẵng, sự kiện đặc sắc đà nẵng" />
				...
				<div class="container">
								...
								typeof="v:Breadcrumb"><a href="index.jsp" rel="v:url"
									...
									typeof="v:Breadcrumb"><a href="Subject_TinTuc.jsp" rel="v:url"
										...
										typeof="v:Breadcrumb"><a href="Subject_GiaiTri.jsp" rel="v:url"
											...
											class="breadcrumb_last">Âm nhạc đường phố đà nẵng, sự
												kiện đặc sắc đà nẵng</span></span></span></span></span>
						</p>
					</ol>
					...
					<div class="hk-left-ct">
						<div class="block-product">
							<h2 class="title">
								<span>Âm nhạc đường phố đà nẵng, sự kiện đặc sắc đà nẵng</span>
							</h2>
							...
							<article class="post-content">
								<h2 class="knc-sapo">Từ nhiều năm nay, tại thành phố Đà
									Nẵng, chương trình “Âm Nhạc Đường Phố” đã thu hút được nhiều sự
									quan tâm tham gia của khách du lịch và người dân địa phương,
									chương trình Âm Nhạc Đường Phố Đà Nẵng thường diễn ra tại phố
									đi bộ Bạch Đằng với nhiều chương rất hấp dẫn và lôi cuốn.</h2>

								<p>
									<img class="aligncenter size-full" src="img/an.JPG" alt=""
										width="600" height="400" />
								</p>

								<p>Đây cũng là chuỗi các hoạt động phụ trợ cho lễ hội Pháo
									hoa quốc tế - DIFC / DIFF chương trình thường diễn ra vào mùa
									hè vào các chiều tối thứ bảy tuần thứ 2 và thứ 4 hàng tháng...
									Chương trình càng trở nên chuyên nghiệp và đặc sắc.</p>

								<p>
									<img class="aligncenter size-full" src="img/an1.JPG" alt=""
										width="600" height="400" />
								</p>
								...
								<div class="knc-content">
									...
									<br />
									<p>Mỗi năm, mỗi tuần chương trình có từng chủ đề khác nhau
										mang đến cho khán giả những trải nghiệm mới lạ. Bên cạnh đó,
										chương trình có sự góp mặt của những môn nghệ thuật đường phố
										(patin, bóng đá nghệ thuật, biểu diễn cầu thủy tinh, con
										quay...) sẽ góp phần tạo nên sự trẻ trung, năng động của
										chương trình này.</p>

									<p>
										<img class="aligncenter size-full" src="img/an2.jpg" alt=""
											width="600" height="400" />
									</p>

									<p>Không gian sân khấu của chương trình Âm Nhạc Đường Phố
										Đà Nẵng được thiết kế rất gần gửi với khán giả, Chương trình
										Âm Nhạc Đường Phô Đà Nẵng đã và tiếp tục là một điểm hẹn âm
										nhạc thường xuyên, và thú vị, một điểm giải trí cho người dân
										địa phương và du khách tản bộ trong mỗi dịp cuối tuần.</p>

									<p>
										<img class="aligncenter size-full" src="img/an3.JPG" alt=""
											width="600" height="400" />
									</p>
									<p>
										<img class="aligncenter size-full" src="img/an4.JPG" alt=""
											width="600" height="400" />
									</p>

									<P>Một số hình ảnh về âm nhạc đường phố Đà Nẵng</P>

									<p>
										<img class="aligncenter size-full" src="img/an5.JPG" alt=""
											width="600" height="400" />
									</p>
									<p>
										<img class="aligncenter size-full" src="img/an6.jpg" alt=""
											width="600" height="400" />
									</p>
									<p>
										<img class="aligncenter size-full" src="img/an7.JPG" alt=""
											width="600" height="400" />
									</p>
									<p>
										<img class="aligncenter size-full" src="img/an8.JPG" alt=""
											width="600" height="400" />
									</p>
									<p>
										<img class="aligncenter size-full" src="img/an9.JPG" alt=""
											width="600" height="400" />
									</p>
