				...
				<form role="form" action="Account_Phieu.jsp">
					...
					<div class="form-group">
						<label>Username:</label> <input type="text" class="form-control"
							id="txtUsername" name="Username" value="<%= resultset.getString(2) %>"
							disabled="disabled"> <label>Password:</label> <input
							type="Password" name="Password" class="form-control" id="txtPass"
							value="<%= resultset.getString(3) %>" disabled=""> <label>Họ và
							tên:</label> <input type="text" class="form-control" id="txtFullname"
							name="Fullname" value="<%= resultset.getString(4) %>"> 
							<label>Ngày Sinh</label> <input type="date" class="form-control" id="txtDate" value="<%= resultset.getString(6) %>">  
							<label>Số điện thoại:</label> <input type="telephone" class="form-control"
							id="txtPhone" name="Phone" value="<%= resultset.getString(7) %>">  <label>Vai
							trò:</label> <br />
							<input type="text" class="form-control"
							id="Quyen" name="Quyen" value="<%= resultset.getString(5) %>"
							disabled="disabled"> 
