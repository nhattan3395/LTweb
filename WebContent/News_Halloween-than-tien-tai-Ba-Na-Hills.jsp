...
<title>Halloween thần tiên tại Bà Nà Hills</title>

<meta property="og:title" content="Halloween thần tiên tại Bà Nà Hills" />
				...
				<div class="container">
								...
								typeof="v:Breadcrumb"><a href="index.jsp" rel="v:url"
									...
									typeof="v:Breadcrumb"><a href="Subject_TinTuc.jsp" rel="v:url"
										...
										typeof="v:Breadcrumb"><a href="Subject_CuocSong.jsp"
											...
											class="breadcrumb_last">Halloween thần tiên tại Bà Nà
												Hills</span></span></span></span></span>
						</p>
					</ol>
					...
					<div class="hk-left-ct">
						<div class="block-product">
							<h2 class="title">
								<span>Halloween thần tiên tại Bà Nà Hills</span>
							</h2>
							...
							<article class="post-content">
								<h2 class="knc-sapo">Không ma mị và rùng rợn, Halloween ở
									Sun World Ba Na Hills đưa du khách hòa mình vào không gian rực
									rỡ và thần thoại mang tên "Xứ sở thần tiên". Ở nơi đó, du khách
									như lạc vào thế giới cổ tích khi gặp gỡ những nhân vật bước ra
									từ những câu chuyện ngày xửa ngày xưa...</h2>
								<p>Ngay khi cabin cáp treo bay trên cánh rừng xanh, vượt
									ngàn mây để lên với miền tiên cảnh, đón chờ du khách là cả một
									không gian ngập tràn sắc vàng cam. Trong khung cảnh ấy, bất cứ
									bức hình nào cũng trở nên rực rỡ, lung linh khiến bạn cứ mải
									miết chụp lại tới quên cả thời gian.</p>

								<div class="knc-content">
									<p>
										<img class="aligncenter size-full" src="img/bnh1.jpg" alt=""
									...
									<br />
									<p>
										<img class="aligncenter size-full" src="img/bnh2.jpg" alt=""
											width="600" height="399" />
									</p>
									<p>
										<img class="aligncenter size-full" src="img/bnh3.jpg" alt=""
											width="600" height="365" />
									</p>
									<p>
										<img class="aligncenter size-full" src="img/bnh4.jpg" alt=""
											width="600" height="398" />
									</p>
									<p>
										<img class="aligncenter size-full" src="img/bnh5.jpg" alt=""
											width="600" height="399" />
									</p>
									<p>Tất nhiên, Halloween sẽ chẳng thể trọn vẹn khi thiếu
										hình ảnh những bóng ma. Và những bóng ma Halloween Sun World
										Ba Na Hills đang ẩn náu ở "Ngôi mộ cổ Andriia" tại tầng B3 Khu
										vui chơi trong nhà Fantasy Park.</p>
									<p>Nơi ấy, những chú "ma công nhân" đang cần mẫn làm việc
										trong hầm mỏ tối tăm, chờ đợi những du khách gan dạ, can đảm
										muốn khám phá thế giới địa ngục đầy rừng rợn và ma mị.</p>
									<p>"Xứ sở thần tiên" ở Sun World Ba Na Hills thật sự là địa
										chỉ lý tưởng trong hành trình khám phá mùa Halloween đặc biệt
										của cả gia đình, nơi những em nhỏ được sống trong thế giới
										thần thiên ngọt ngào, và người lớn tìm lại được khoảng khắc
										tuổi thơ với những câu truyện cổ trăm năm.</p>
									<p>Chỉ còn hai tuần nữa từ nay cho tới hết 31/10 khi lễ hội
										Halloween kết thúc, hãy cùng người thân, bạn bè tới Sun World
										Ba Na Hills để lưu giữ những kí ức vui vẻ và đặc biệt nhất ở
										xứ thần tiên.</p>
									<p>
										<img class="aligncenter size-full" src="img/bnh6.jpg" alt=""
											width="600" height="399" />
									</p>

									<p>Từ 19h tới đêm muộn ngày 27/10/2017, du khách có thêm
										trải nghiệm Halloween hoàn toàn khác lạ trong không gian ma mị
										tại bữa tiệc Pool Party sôi động, lần đầu tiên được tổ chức
										tại bể bơi La Piscine của Mercure Bana Hills French Village
										(thuộc khu vực Làng Pháp – Sun World Ba Na Hills). Sự kết hợp
										giữa âm nhạc ma mị, ẩm thực độc đáo cùng trò chơi huyền bí
										đúng tinh thần Halloween sẽ mang đến những giây phút khó quên
										cho tất thảy du khách.</p>
									<p>Chương trình mở cửa tự do. Đặc biệt, các du khách đặt
										phòng tại Mercure Bana Hills French Village trước ngày 20/10
										sẽ được tặng 200.000 đồng, tương đương với 200 tokens để sử
										dụng cho dịch vụ ẩm thực tại buổi tiệc.</p>
								</div>
							</article>
						</div>
						<!-- End block-product -->
